...
public class TimeInterval1TIA extends TimeIntervalAutomaton {

    public TimeInterval1TIA(Agent agent, String name) {
        super(agent, name);
        setMetadata("SOCIAALML_ENTITY_ID", "TimeInterval1");
	...
	public void initSubAutomaton() {
		FSM fsm = new FSM(agent, 1,"FSM-TimeInterval1TIA");
