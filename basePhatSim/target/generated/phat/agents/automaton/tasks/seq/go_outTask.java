...
public class go_outTask extends SeqTaskAutomaton {

	public go_outTask(Agent agent, String name) {
            super(agent, name);
            setMetadata("SOCIAALML_ENTITY_ID", "go_out");
	...
	public void initTasks() {
		
		{
                Automaton automaton = new MoveToSpace(
                 ...
                 .setMetadata("SOCIAALML_DESCRIPTION", "")
                 .setMetadata("SOCIAALML_ENTITY_ID", "BGoToTask10")
