 ...
 * @author pablo
 */
public class MainSimNoSymptomsPHATSimulationNoDevicesRecord extends MainSimNoSymptomsPHATSimulationNoDevices {
	static MonitorEventQueueImp meq=new MonitorEventQueueImp();
    public static void main(String[] args) throws RemoteException, AlreadyBoundException, NotBoundException {
    	meq.startServer(MonitorEventQueue.DefaultName);
        MainSimNoSymptomsPHATSimulationNoDevicesRecord sim = new MainSimNoSymptomsPHATSimulationNoDevicesRecord();
