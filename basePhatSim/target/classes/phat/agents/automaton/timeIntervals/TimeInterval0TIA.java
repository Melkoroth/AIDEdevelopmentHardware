...
public class TimeInterval0TIA extends TimeIntervalAutomaton {

    public TimeInterval0TIA(Agent agent, String name) {
        super(agent, name);
        setMetadata("SOCIAALML_ENTITY_ID", "TimeInterval0");
	...
	public void initSubAutomaton() {
		FSM fsm = new FSM(agent, 1,"FSM-TimeInterval0TIA");
